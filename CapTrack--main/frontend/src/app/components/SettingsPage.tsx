          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Basic profile information used across CapTrack.</p>
              </div>
            </div>
            ...
            <div className="mt-6">
              <h3 className="text-lg font-semibold text-slate-800 mb-2">Research Interests</h3>
              <textarea
                rows={4}
                placeholder="Describe preferred project domains, ideas, and career goals..."
            ...
            <div className="mt-6">
              <h3 className="text-lg font-semibold text-slate-800 mb-2">Technical & Professional Skills</h3>
