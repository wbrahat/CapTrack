...
import { AdminSemestersPage } from "./components/AdminSemestersPage";
...
export default function App() {
  ...
  const renderPage = () => {
    ...
    if (role === "student" && !isProjectGroupAssigned && projectPages.includes(page)) {
    ...
    switch (page) {
      case "dashboard":
        if (role === "supervisor") {
          return <SupervisorDashboard onNavigate={(newPage) => setPage(newPage as Page)} />;
        }
