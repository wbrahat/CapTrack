...
export function Sidebar({
  ...
  const canUseProjectTools = role !== "student" || isProjectGroupAssigned;
  const [projectSectionOpen, setProjectSectionOpen] = useState(canUseProjectTools);
        ...
        {role !== "admin" && (
          <>
            ...
            <div className="space-y-1">
              ...
              {canUseProjectTools && projectSectionOpen && (
